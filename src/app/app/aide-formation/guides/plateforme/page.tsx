...
const USAGE_ROLE: Record<RoleId, string> = {
  ...
  gestionnaire_financier: "Responsable administratif et financier : frais scolaires, créances et recouvrement, budgets, trésorerie, supervision des encaissements, clôtures d'exercice et exports comptables.",
  comptable: "Tient la comptabilité : consultation des écritures et états financiers, rapprochements bancaires (pointage, relevés), écritures d'ajustement autorisées et exports comptables. Ne peut pas encaisser ni modifier les tarifs.",
  caissier: "Tient la caisse : encaissement des paiements de scolarité avec reçus numérotés, avances et acomptes, paiement des remboursements validés. Ne modifie ni les frais, ni les budgets.",
  magasinier: "Tient les stocks de l'économat : entrées, sorties (ventes) et inventaires, consultation des articles. Ne modifie pas les prix.",
  auditeur: "Consulte en LECTURE SEULE toutes les données financières de l'établissement (tableaux de bord, comptes des élèves, journaux) et exporte les rapports. Ne modifie jamais une donnée.",
  commissaire_comptes: "Contrôle légal des comptes : mêmes droits de lecture seule que l'auditeur, pour une mission généralement temporaire. Ne modifie jamais une donnée.",
...
const PAS_A_PAS: Record<RoleId, string[]> = {
  ...
  gestionnaire_financier: [
    "Ouvrez Économat › Finances.",
    "Paramétrez le barème des frais, les catégories et leurs priorités d'imputation.",
    "Générez les créances (élève, classe ou établissement) et suivez le recouvrement.",
    "Préparez le budget prévisionnel et suivez la trésorerie.",
    "Lancez les clôtures d'exercice et exportez les états comptables.",
  ],
  comptable: [
    "Ouvrez Économat › Finances.",
    "Consultez les écritures, la balance et les états financiers.",
    "Effectuez le rapprochement bancaire : pointage des écritures, saisie des relevés mensuels.",
    "Passez les écritures d'ajustement autorisées (recettes/dépenses diverses).",
    "Exportez le fichier des écritures comptables (CSV normalisé).",
  ],
  caissier: [
    "Ouvrez Économat › Finances › Encaissements.",
    "Encaissez les paiements de scolarité : un reçu numéroté imprimable est produit à chaque encaissement.",
    "Enregistrez les avances et imputez-les sur les créances (Compte élève).",
    "Payez les remboursements préalablement validés.",
  ],
  magasinier: [
    "Ouvrez Économat › Finances › Économat.",
    "Enregistrez les entrées de stock et les sorties (ventes).",
    "Réalisez les inventaires (ajustements de stock).",
    "Surveillez les alertes de seuil.",
  ],
  auditeur: [
    "Ouvrez Économat › Finances : toutes les données sont consultables en lecture seule.",
    "Consultez les comptes financiers des élèves, les journaux et les clôtures.",
    "Exportez les rapports et le fichier des écritures comptables.",
  ],
  commissaire_comptes: [
    "Ouvrez Économat › Finances : consultation en lecture seule, identique à l'auditeur.",
    "Consultez les journaux, les clôtures et les états financiers de votre mission.",
    "Exportez les pièces nécessaires à votre rapport.",
  ],
  directeur_etudes: [
