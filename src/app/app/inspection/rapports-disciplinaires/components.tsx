...
import { BookmarkPlus, Eye, Plus, Save, Undo2, Wand2 } from "lucide-react";
...
// ── Formulaire complet du rapport bilan CRD (composants partagés : composants-rapport.tsx) ──
...
export function RapportCrdForm({
  ...
  function ajouterLigne(cle: CleTableau, nbColonnes: number) {
    setTables((prev) =>
      prev[cle].length >= 40 ? prev : { ...prev, [cle]: [...prev[cle], ligneVide(nbColonnes)] },
    );
  }
