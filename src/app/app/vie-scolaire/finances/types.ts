...
export interface PaiementVue { id: string; numeroRecu: number; eleveId: string; eleveNom: string; classe: string | null; libelle: string; montant: number; mode: string; reference: string | null; date: string; annule: boolean; motifAnnulation: string | null; pointeLe: string | null }
...
export interface OperationVue { id: string; sens: string; categorie: string; libelle: string; montant: number; mode: string; reference: string | null; date: string; annule: boolean; pointeLe: string | null }
