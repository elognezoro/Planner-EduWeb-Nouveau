...
import { Card, StatCard } from "@/components/app/ui";
...
export default async function StatistiquesCafopTabPage() {
  ...
  const where = u.roleReel === "cafop_admin" ? { id: u.portee.cafopId ?? "__aucune__", pays } : { pays };
  const [cafops, regions] = await Promise.all([
  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      <EnteteCafop ongletActif="statistiques" nbCentres={kpis.cafops} regions={regions} terme={terme} />
