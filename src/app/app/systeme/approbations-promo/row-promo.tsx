...
/** Instruction d'une demande en attente : choix du code promo à attribuer + approuver / refuser. */
  ...
  return (
    <div className="flex shrink-0 flex-col items-stretch gap-2 sm:items-end">
      <form action={approuver} className="flex flex-wrap items-end justify-end gap-2">
        ...
        <div>
          <label className="mb-1 block text-[0.65rem] font-medium text-ink-700/60">Code à attribuer</label>
          <select
            name="code"
            required
            defaultValue=""
