...
/**
 * Fiche de configuration d'une APFC (renommage, rattachement à la région) — l'équivalent
 * minimal de la « Fiche du centre » CAFOP (configurer-cafop.tsx), le modèle Apfc ne portant
 * pas d'autres coordonnées. Masquée si `peutModifier` est faux (guide d'écriture réservée).
 */
