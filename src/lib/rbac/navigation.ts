  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icone: "Users",
        roles: ["admin", "superviseur_international", "superviseur_national", "representant_pays", "etablissements_admin", "cafop_admin", "apfc_admin"],
        statut: "disponible",
        phase: 1,
      ...
      },
      {
        ...
        icone: "School",
        roles: ["admin", "superviseur_international", "superviseur_national", "representant_pays", "etablissements_admin", "chef_etablissement", "adjoint_chef_etablissement"],
        statut: "disponible",
        phase: 2,
      },
      {
        ...
        icone: "GraduationCap",
        roles: ["admin", "superviseur_international", "representant_pays", "cafop_admin"],
        statut: "disponible",
        phase: 5,
      ...
      },
      {
        ...
        icone: "CalendarRange",
        roles: ["admin", "superviseur_international", "representant_pays", "cafop_admin", "drena", "apfc_admin"],
        statut: "disponible",
        phase: 5,
      ...
      },
      {
        ...
        icone: "Network",
        roles: ["admin", "superviseur_international", "representant_pays", "apfc_admin"],
        statut: "disponible",
        phase: 5,
