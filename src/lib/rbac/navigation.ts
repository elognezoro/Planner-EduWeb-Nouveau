  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icone: "School",
        roles: ["admin", "etablissements_admin", "chef_etablissement", "adjoint_chef_etablissement"],
        statut: "disponible",
        phase: 2,
      },
      {
      ...
      },
      {
        ...
        statut: "disponible",
        phase: 5,
        description: "Effectifs des promotions d'élèves-maîtres.",
      },
      {
        id: "rapports-cafop",
        ...
        statut: "disponible",
        phase: 5,
        description: "Promotions et effectifs CAFOP.",
      },
      {
        id: "apfc",
        libelle: "APFC",
