...
export const NAVIGATION: SectionNav[] = [
  ...
  },
  {
    ...
    items: [
      {
        // Console de GESTION des structures APFC (création/configuration) — conservée en tête
        // de section pour ne pas perdre l'accès des administrateurs après la refonte du menu.
        id: "apfc-gestion",
        libelle: "Gestion des APFC",
      ...
      {
        id: "supervision-apfc",
        libelle: "Supervision APFC",
        segment: "inspection/supervision-apfc",
        icone: "Radar",
        roles: [
          "admin",
          "superviseur_international",
        ...
        statut: "disponible",
        phase: 6,
        description: "Vue d'ensemble du réseau des antennes : cohortes actives et encadrement.",
      },
      {
        id: "rapports-disciplinaires",
        libelle: "Rapports Pédagogiques Disciplinaires",
        segment: "inspection/rapports-disciplinaires",
        icone: "BookOpenCheck",
        roles: ["admin", "inspecteur", "drena"],
        statut: "disponible",
        phase: 6,
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icone: "UserCheck",
        roles: ["admin", "chef_etablissement", "etablissements_admin"],
        statut: "disponible",
        phase: 3,
      ...
      },
      {
        ...
        icone: "GraduationCap",
        roles: ["admin", "chef_etablissement", "etablissements_admin", "educateur"],
        statut: "disponible",
        phase: 3,
      ...
      },
      {
        ...
        icone: "ClipboardList",
        roles: ["admin", "chef_etablissement", "etablissements_admin", "enseignant", "educateur"],
        statut: "disponible",
        phase: 3,
      },
      {
      ...
      },
      {
        ...
        icone: "NotebookPen",
        roles: ["admin", "chef_etablissement", "etablissements_admin", "adjoint_chef_etablissement", "enseignant", "parent", "eleve"],
        statut: "disponible",
        phase: 3,
      ...
      },
      {
        ...
        icone: "BookOpen",
        roles: ["admin", "chef_etablissement", "etablissements_admin", "adjoint_chef_etablissement", "inspecteur_orientation", "educateur", "enseignant"],
        statut: "disponible",
        phase: 3,
      },
      {
        ...
        icone: "BookMarked",
        roles: ["admin", "chef_etablissement", "etablissements_admin", "adjoint_chef_etablissement", "inspecteur_orientation", "enseignant", "parent", "eleve"],
        statut: "disponible",
        phase: 3,
      ...
      },
      {
        ...
        icone: "CalendarClock",
        roles: ["admin", "chef_etablissement", "etablissements_admin", "adjoint_chef_etablissement", "inspecteur_orientation", "enseignant", "educateur", "parent"],
        statut: "disponible",
        phase: 7,
      ...
      },
      {
        ...
        icone: "Megaphone",
        roles: ["admin", "super_admin_etablissements", "chef_etablissement", "etablissements_admin", "educateur"],
        statut: "disponible",
        phase: 7,
    ...
    items: [
      {
        ...
        icone: "BarChart3",
        roles: ["admin", "chef_etablissement", "etablissements_admin", "adjoint_chef_etablissement", "inspecteur_orientation", "enseignant"],
        statut: "disponible",
        phase: 6,
      ...
      },
      {
        ...
        icone: "TrendingUp",
        roles: ["admin", "drena", "chef_etablissement", "etablissements_admin"],
        statut: "disponible",
        phase: 6,
      ...
      },
      {
        ...
        icone: "Gauge",
        roles: ["admin", "inspecteur", "drena", "chef_etablissement", "etablissements_admin"],
        statut: "disponible",
        phase: 6,
