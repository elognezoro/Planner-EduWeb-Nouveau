      ...
      <Container className="relative grid items-center gap-14 pb-24 pt-36 lg:grid-cols-[1.05fr_0.95fr] lg:pb-32 lg:pt-44">
        ...
        >
          ...
          <motion.div
            ...
            className="animate-float absolute -right-3 -top-5 z-20 hidden items-center gap-2 rounded-2xl border border-cream-50/15 bg-forest-900/80 px-3 py-2 shadow-2xl backdrop-blur-xl lg:flex"
          >
